// Taken from: https://github.com/JXA-userland/JXA/blob/master/packages/@jxa/types/test/fixtures/GoogleChrome.d.ts
...
export namespace GoogleChrome {
  ...
  export interface Tab {
    ...
    // CUSTOM: Taken from Chrome interface below
    /**
    ...
    execute(
      directParameter: any,
      option?: GoogleChrome.ExecuteOptionalParameter
    ): any;
  }
...
export interface GoogleChrome extends GoogleChrome.Application {
  ...
  count(
    directParameter: any,
    option?: GoogleChrome.CountOptionalParameter
  ): number;
  ...
  duplicate(
    directParameter: any,
    option?: GoogleChrome.DuplicateOptionalParameter
  ): any;
